...
document.getElementById("currentUserId1").textContent="";
          ...
          window.pm.methods.createUser(username,password,"0x4837f02ac920dfc9f9f4d90ee9e96934f8981c52",usertype).send({ from: window.accounts[0] , gas: 500000 }, function (error, result) {
        if (error) {
            console.log(error)
            console.log("false")
        } else {
